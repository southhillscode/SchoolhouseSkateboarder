...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //The size of the sidewalk brick grraphics used
    ...
    override func update(_ currentTime: TimeInterval){
        ...
        // Stops game if GameState is not set to running
        ...
        let scrollAdjustment = CGFloat(elaspedTime / expectedElapsedTime)
    ...
    func setupLabels() {
        ...
        highScoreTextLabel.position = CGPoint(x: frame.size.width, y: frame.size.height - 20.0)
        ...
        highScoreLabel.position = CGPoint(x: frame.size.width, y: frame.size.height - 40.0)
    ...
    func updateBricks(withScrollAmount currentScrollAmount: CGFloat) {
        ...
        //Keep track of the greates x-position of all the current bricks
        ...
        for brick in bricks{
            ...
            if newX < -brickSize.width {
                ...
                //For a brick that is still onscreen, update its postion
    ...
    func updateScore(withCurrentTime currentTime: TimeInterval) {
        ...
        let elaspedTime = currentTime - lastScoreUpdateTime
